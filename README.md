...
Update time:  2019-03-20 14:47:22

Auto created by [leetcode_generate](https://github.com/bonfy/leetcode)

I have solved **119   /   961** problems
...
|2|[add-two-numbers](https://leetcode.com/problems/add-two-numbers)|[Python3](https://github.com/mengban/leetcode/blob/master/002-add-two-numbers/add-two-numbers.py)|[:memo:](https://leetcode.com/articles/add-two-numbers/)|Medium|
|3|[longest-substring-without-repeating-characters](https://leetcode.com/problems/longest-substring-without-repeating-characters)|[Python3](https://github.com/mengban/leetcode/blob/master/003-longest-substring-without-repeating-characters/longest-substring-without-repeating-characters.py)|[:memo:](https://leetcode.com/articles/longest-substring-without-repeating-characters/)|Medium|
...
|14|[longest-common-prefix](https://leetcode.com/problems/longest-common-prefix)|[Python3](https://github.com/mengban/leetcode/blob/master/014-longest-common-prefix/longest-common-prefix.py)|[:memo:](https://leetcode.com/articles/longest-common-prefix/)|Easy|
|15|[3sum](https://leetcode.com/problems/3sum)|[Python3](https://github.com/mengban/leetcode/blob/master/015-3sum/3sum.py)||Medium|
|16|[3sum-closest](https://leetcode.com/problems/3sum-closest)|||Medium|
|17|[letter-combinations-of-a-phone-number](https://leetcode.com/problems/letter-combinations-of-a-phone-number)|[Python3](https://github.com/mengban/leetcode/blob/master/017-letter-combinations-of-a-phone-number/letter-combinations-of-a-phone-number.py)|[:memo:](https://leetcode.com/articles/letter-combinations-of-a-phone-number/)|Medium|
|18|[4sum](https://leetcode.com/problems/4sum)|||Medium|
|19|[remove-nth-node-from-end-of-list](https://leetcode.com/problems/remove-nth-node-from-end-of-list)|[Python3](https://github.com/mengban/leetcode/blob/master/019-remove-nth-node-from-end-of-list/remove-nth-node-from-end-of-list.py)|[:memo:](https://leetcode.com/articles/remove-nth-node-from-end-of-list/)|Medium|
|20|[valid-parentheses](https://leetcode.com/problems/valid-parentheses)|[Python3](https://github.com/mengban/leetcode/blob/master/020-valid-parentheses/valid-parentheses.py)|[:memo:](https://leetcode.com/articles/valid-parentheses/)|Easy|
|21|[merge-two-sorted-lists](https://leetcode.com/problems/merge-two-sorted-lists)|[Python3](https://github.com/mengban/leetcode/blob/master/021-merge-two-sorted-lists/merge-two-sorted-lists.py)|[:memo:](https://leetcode.com/articles/merged-two-sorted-lists/)|Easy|
...
|24|[swap-nodes-in-pairs](https://leetcode.com/problems/swap-nodes-in-pairs)|[Python3](https://github.com/mengban/leetcode/blob/master/024-swap-nodes-in-pairs/swap-nodes-in-pairs.py)||Medium|
|25|[reverse-nodes-in-k-group](https://leetcode.com/problems/reverse-nodes-in-k-group)|[Python3](https://github.com/mengban/leetcode/blob/master/025-reverse-nodes-in-k-group/reverse-nodes-in-k-group.py)||Hard|
...
|28|[implement-strstr](https://leetcode.com/problems/implement-strstr)|[Python3](https://github.com/mengban/leetcode/blob/master/028-implement-strstr/implement-strstr.py)||Easy|
...
|40|[combination-sum-ii](https://leetcode.com/problems/combination-sum-ii)|[Python3](https://github.com/mengban/leetcode/blob/master/040-combination-sum-ii/combination-sum-ii.py)||Medium|
...
|43|[multiply-strings](https://leetcode.com/problems/multiply-strings)|[Python3](https://github.com/mengban/leetcode/blob/master/043-multiply-strings/multiply-strings.py)||Medium|
|44|[wildcard-matching](https://leetcode.com/problems/wildcard-matching)|||Hard|
|45|[jump-game-ii](https://leetcode.com/problems/jump-game-ii)|||Hard|
|46|[permutations](https://leetcode.com/problems/permutations)|[Python3](https://github.com/mengban/leetcode/blob/master/046-permutations/permutations.py)|[:memo:](https://leetcode.com/articles/permutations/)|Medium|
...
|61|[rotate-list](https://leetcode.com/problems/rotate-list)|[Python3](https://github.com/mengban/leetcode/blob/master/061-rotate-list/rotate-list.py)|[:memo:](https://leetcode.com/articles/rotate-list/)|Medium|
...
|64|[minimum-path-sum](https://leetcode.com/problems/minimum-path-sum)|[Python3](https://github.com/mengban/leetcode/blob/master/064-minimum-path-sum/minimum-path-sum.py)|[:memo:](https://leetcode.com/articles/minimum-path-sum/)|Medium|
...
|67|[add-binary](https://leetcode.com/problems/add-binary)|[Python3](https://github.com/mengban/leetcode/blob/master/067-add-binary/add-binary.py)||Easy|
|68|[text-justification](https://leetcode.com/problems/text-justification)|||Hard|
|69|[sqrtx](https://leetcode.com/problems/sqrtx)|[Python3](https://github.com/mengban/leetcode/blob/master/069-sqrtx/sqrtx.py)||Easy|
|70|[climbing-stairs](https://leetcode.com/problems/climbing-stairs)|[Python3](https://github.com/mengban/leetcode/blob/master/070-climbing-stairs/climbing-stairs.py)|[:memo:](https://leetcode.com/articles/climbing-stairs/)|Easy|
|71|[simplify-path](https://leetcode.com/problems/simplify-path)|||Medium|
|72|[edit-distance](https://leetcode.com/problems/edit-distance)|[Python3](https://github.com/mengban/leetcode/blob/master/072-edit-distance/edit-distance.py)|[:memo:](https://leetcode.com/articles/edit-distance/)|Hard|
|73|[set-matrix-zeroes](https://leetcode.com/problems/set-matrix-zeroes)|[Python3](https://github.com/mengban/leetcode/blob/master/073-set-matrix-zeroes/set-matrix-zeroes.py)|[:memo:](https://leetcode.com/articles/set-matrix-zeroes/)|Medium|
|74|[search-a-2d-matrix](https://leetcode.com/problems/search-a-2d-matrix)|[Python3](https://github.com/mengban/leetcode/blob/master/074-search-a-2d-matrix/search-a-2d-matrix.py)||Medium|
|75|[sort-colors](https://leetcode.com/problems/sort-colors)|[Python3](https://github.com/mengban/leetcode/blob/master/075-sort-colors/sort-colors.py)||Medium|
...
|80|[remove-duplicates-from-sorted-array-ii](https://leetcode.com/problems/remove-duplicates-from-sorted-array-ii)|[Python3](https://github.com/mengban/leetcode/blob/master/080-remove-duplicates-from-sorted-array-ii/remove-duplicates-from-sorted-array-ii.py)||Medium|
|81|[search-in-rotated-sorted-array-ii](https://leetcode.com/problems/search-in-rotated-sorted-array-ii)|||Medium|
|82|[remove-duplicates-from-sorted-list-ii](https://leetcode.com/problems/remove-duplicates-from-sorted-list-ii)|[Python3](https://github.com/mengban/leetcode/blob/master/082-remove-duplicates-from-sorted-list-ii/remove-duplicates-from-sorted-list-ii.py)||Medium|
|83|[remove-duplicates-from-sorted-list](https://leetcode.com/problems/remove-duplicates-from-sorted-list)|[Python3](https://github.com/mengban/leetcode/blob/master/083-remove-duplicates-from-sorted-list/remove-duplicates-from-sorted-list.py)|[:memo:](https://leetcode.com/articles/remove-duplicates-from-sorted-list/)|Easy|
...
|88|[merge-sorted-array](https://leetcode.com/problems/merge-sorted-array)|[Python3](https://github.com/mengban/leetcode/blob/master/088-merge-sorted-array/merge-sorted-array.py)|[:memo:](https://leetcode.com/articles/merge-sorted-arrays/)|Easy|
...
|94|[binary-tree-inorder-traversal](https://leetcode.com/problems/binary-tree-inorder-traversal)|[Python3](https://github.com/mengban/leetcode/blob/master/094-binary-tree-inorder-traversal/binary-tree-inorder-traversal.py)|[:memo:](https://leetcode.com/articles/binary-tree-inorder-traversal/)|Medium|
...
|96|[unique-binary-search-trees](https://leetcode.com/problems/unique-binary-search-trees)|[Python3](https://github.com/mengban/leetcode/blob/master/096-unique-binary-search-trees/unique-binary-search-trees.py)|[:memo:](https://leetcode.com/articles/unique-binary-search-trees/)|Medium|
...
|100|[same-tree](https://leetcode.com/problems/same-tree)|[Python3](https://github.com/mengban/leetcode/blob/master/100-same-tree/same-tree.py)|[:memo:](https://leetcode.com/articles/same-tree/)|Easy|
|101|[symmetric-tree](https://leetcode.com/problems/symmetric-tree)|[Python3](https://github.com/mengban/leetcode/blob/master/101-symmetric-tree/symmetric-tree.py)|[:memo:](https://leetcode.com/articles/symmetric-tree/)|Easy|
...
|104|[maximum-depth-of-binary-tree](https://leetcode.com/problems/maximum-depth-of-binary-tree)|[Python3](https://github.com/mengban/leetcode/blob/master/104-maximum-depth-of-binary-tree/maximum-depth-of-binary-tree.py)|[:memo:](https://leetcode.com/articles/maximum-depth-of-binary-tree/)|Easy|
|105|[construct-binary-tree-from-preorder-and-inorder-traversal](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal)|[Python3](https://github.com/mengban/leetcode/blob/master/105-construct-binary-tree-from-preorder-and-inorder-traversal/construct-binary-tree-from-preorder-and-inorder-traversal.py)|[:memo:](https://leetcode.com/articles/construct-binary-tree-from-preorder-and-inorder-tr/)|Medium|
|106|[construct-binary-tree-from-inorder-and-postorder-traversal](https://leetcode.com/problems/construct-binary-tree-from-inorder-and-postorder-traversal)|||Medium|
|107|[binary-tree-level-order-traversal-ii](https://leetcode.com/problems/binary-tree-level-order-traversal-ii)|[Python3](https://github.com/mengban/leetcode/blob/master/107-binary-tree-level-order-traversal-ii/binary-tree-level-order-traversal-ii.py)||Easy|
|108|[convert-sorted-array-to-binary-search-tree](https://leetcode.com/problems/convert-sorted-array-to-binary-search-tree)|[Python3](https://github.com/mengban/leetcode/blob/master/108-convert-sorted-array-to-binary-search-tree/convert-sorted-array-to-binary-search-tree.py)||Easy|
...
|110|[balanced-binary-tree](https://leetcode.com/problems/balanced-binary-tree)|[Python3](https://github.com/mengban/leetcode/blob/master/110-balanced-binary-tree/balanced-binary-tree.py)||Easy|
|111|[minimum-depth-of-binary-tree](https://leetcode.com/problems/minimum-depth-of-binary-tree)|[Python3](https://github.com/mengban/leetcode/blob/master/111-minimum-depth-of-binary-tree/minimum-depth-of-binary-tree.py)|[:memo:](https://leetcode.com/articles/minimum-depth-of-binary-tree/)|Easy|
|112|[path-sum](https://leetcode.com/problems/path-sum)|[Python3](https://github.com/mengban/leetcode/blob/master/112-path-sum/path-sum.py)|[:memo:](https://leetcode.com/articles/path-sum/)|Easy|
|113|[path-sum-ii](https://leetcode.com/problems/path-sum-ii)|[Python3](https://github.com/mengban/leetcode/blob/master/113-path-sum-ii/path-sum-ii.py)||Medium|
|114|[flatten-binary-tree-to-linked-list](https://leetcode.com/problems/flatten-binary-tree-to-linked-list)|[Python3](https://github.com/mengban/leetcode/blob/master/114-flatten-binary-tree-to-linked-list/flatten-binary-tree-to-linked-list.py)||Medium|
...
|120|[triangle](https://leetcode.com/problems/triangle)|[Python3](https://github.com/mengban/leetcode/blob/master/120-triangle/triangle.py)||Medium|
...
|122|[best-time-to-buy-and-sell-stock-ii](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-ii)|[Python3](https://github.com/mengban/leetcode/blob/master/122-best-time-to-buy-and-sell-stock-ii/best-time-to-buy-and-sell-stock-ii.py)|[:memo:](https://leetcode.com/articles/best-time-to-buy-and-sell-stock-ii/)|Easy|
...
|125|[valid-palindrome](https://leetcode.com/problems/valid-palindrome)|[Python3](https://github.com/mengban/leetcode/blob/master/125-valid-palindrome/valid-palindrome.py)||Easy|
...
|129|[sum-root-to-leaf-numbers](https://leetcode.com/problems/sum-root-to-leaf-numbers)|[Python3](https://github.com/mengban/leetcode/blob/master/129-sum-root-to-leaf-numbers/sum-root-to-leaf-numbers.py)||Medium|
...
|143|[reorder-list](https://leetcode.com/problems/reorder-list)|[Python3](https://github.com/mengban/leetcode/blob/master/143-reorder-list/reorder-list.py)||Medium|
...
|167|[two-sum-ii-input-array-is-sorted](https://leetcode.com/problems/two-sum-ii-input-array-is-sorted)|[Python3](https://github.com/mengban/leetcode/blob/master/167-two-sum-ii-input-array-is-sorted/two-sum-ii-input-array-is-sorted.py)|[:memo:](https://leetcode.com/articles/two-sum-ii-input-array-is-sorted/)|Easy|
|168|[excel-sheet-column-title](https://leetcode.com/problems/excel-sheet-column-title)|||Easy|
|169|[majority-element](https://leetcode.com/problems/majority-element)|[Python3](https://github.com/mengban/leetcode/blob/master/169-majority-element/majority-element.py)|[:memo:](https://leetcode.com/articles/majority-element/)|Easy|
...
|202|[happy-number](https://leetcode.com/problems/happy-number)|[Python3](https://github.com/mengban/leetcode/blob/master/202-happy-number/happy-number.py)||Easy|
...
|217|[contains-duplicate](https://leetcode.com/problems/contains-duplicate)|[Python3](https://github.com/mengban/leetcode/blob/master/217-contains-duplicate/contains-duplicate.py)|[:memo:](https://leetcode.com/articles/contains-duplicate/)|Easy|
|218|[the-skyline-problem](https://leetcode.com/problems/the-skyline-problem)|||Hard|
|219|[contains-duplicate-ii](https://leetcode.com/problems/contains-duplicate-ii)|[Python3](https://github.com/mengban/leetcode/blob/master/219-contains-duplicate-ii/contains-duplicate-ii.py)|[:memo:](https://leetcode.com/articles/contains-duplicate-ii/)|Easy|
...
|225|[implement-stack-using-queues](https://leetcode.com/problems/implement-stack-using-queues)|[Python3](https://github.com/mengban/leetcode/blob/master/225-implement-stack-using-queues/implement-stack-using-queues.py)|[:memo:](https://leetcode.com/articles/implement-stack-using-queues/)|Easy|
|226|[invert-binary-tree](https://leetcode.com/problems/invert-binary-tree)|[Python3](https://github.com/mengban/leetcode/blob/master/226-invert-binary-tree/invert-binary-tree.py)|[:memo:](https://leetcode.com/articles/invert-binary-tree/)|Easy|
...
|232|[implement-queue-using-stacks](https://leetcode.com/problems/implement-queue-using-stacks)|[Python3](https://github.com/mengban/leetcode/blob/master/232-implement-queue-using-stacks/implement-queue-using-stacks.py)|[:memo:](https://leetcode.com/articles/implement-queue-using-stacks/)|Easy|
...
|242|[valid-anagram](https://leetcode.com/problems/valid-anagram)|[Python3](https://github.com/mengban/leetcode/blob/master/242-valid-anagram/valid-anagram.py)|[:memo:](https://leetcode.com/articles/valid-anagram/)|Easy|
...
|257|[binary-tree-paths](https://leetcode.com/problems/binary-tree-paths)|[Python3](https://github.com/mengban/leetcode/blob/master/257-binary-tree-paths/binary-tree-paths.py)|[:memo:](https://leetcode.com/articles/binary-tree-paths/)|Easy|
|258|[add-digits](https://leetcode.com/problems/add-digits)|[Python3](https://github.com/mengban/leetcode/blob/master/258-add-digits/add-digits.py)||Easy|
...
|263|[ugly-number](https://leetcode.com/problems/ugly-number)|[Python3](https://github.com/mengban/leetcode/blob/master/263-ugly-number/ugly-number.py)||Easy|
...
|268|[missing-number](https://leetcode.com/problems/missing-number)|[Python3](https://github.com/mengban/leetcode/blob/master/268-missing-number/missing-number.py)|[:memo:](https://leetcode.com/articles/missing-number/)|Easy|
...
|326|[power-of-three](https://leetcode.com/problems/power-of-three)|[Python3](https://github.com/mengban/leetcode/blob/master/326-power-of-three/power-of-three.py)|[:memo:](https://leetcode.com/articles/power-of-three/)|Easy|
...
|344|[reverse-string](https://leetcode.com/problems/reverse-string)|[Python3](https://github.com/mengban/leetcode/blob/master/344-reverse-string/reverse-string.py)||Easy|
...
|349|[intersection-of-two-arrays](https://leetcode.com/problems/intersection-of-two-arrays)|[Python3](https://github.com/mengban/leetcode/blob/master/349-intersection-of-two-arrays/intersection-of-two-arrays.py)|[:memo:](https://leetcode.com/articles/intersection-of-two-arrays/)|Easy|
|350|[intersection-of-two-arrays-ii](https://leetcode.com/problems/intersection-of-two-arrays-ii)|[Python3](https://github.com/mengban/leetcode/blob/master/350-intersection-of-two-arrays-ii/intersection-of-two-arrays-ii.py)||Easy|
...
|367|[valid-perfect-square](https://leetcode.com/problems/valid-perfect-square)|[Python3](https://github.com/mengban/leetcode/blob/master/367-valid-perfect-square/valid-perfect-square.py)||Easy|
...
|378|[kth-smallest-element-in-a-sorted-matrix](https://leetcode.com/problems/kth-smallest-element-in-a-sorted-matrix)|[Python3](https://github.com/mengban/leetcode/blob/master/378-kth-smallest-element-in-a-sorted-matrix/kth-smallest-element-in-a-sorted-matrix.py)||Medium|
...
|404|[sum-of-left-leaves](https://leetcode.com/problems/sum-of-left-leaves)|[Python3](https://github.com/mengban/leetcode/blob/master/404-sum-of-left-leaves/sum-of-left-leaves.py)||Easy|
...
|409|[longest-palindrome](https://leetcode.com/problems/longest-palindrome)|[Python3](https://github.com/mengban/leetcode/blob/master/409-longest-palindrome/longest-palindrome.py)|[:memo:](https://leetcode.com/articles/longest-palindrome/)|Easy|
...
|434|[number-of-segments-in-a-string](https://leetcode.com/problems/number-of-segments-in-a-string)|[Python3](https://github.com/mengban/leetcode/blob/master/434-number-of-segments-in-a-string/number-of-segments-in-a-string.py)|[:memo:](https://leetcode.com/articles/number-of-segments-in-a-string/)|Easy|
...
|441|[arranging-coins](https://leetcode.com/problems/arranging-coins)|[Python3](https://github.com/mengban/leetcode/blob/master/441-arranging-coins/arranging-coins.py)||Easy|
...
|459|[repeated-substring-pattern](https://leetcode.com/problems/repeated-substring-pattern)|[Python3](https://github.com/mengban/leetcode/blob/master/459-repeated-substring-pattern/repeated-substring-pattern.py)||Easy|
...
|496|[next-greater-element-i](https://leetcode.com/problems/next-greater-element-i)|[Python3](https://github.com/mengban/leetcode/blob/master/496-next-greater-element-i/next-greater-element-i.py)|[:memo:](https://leetcode.com/articles/greater-element-i/)|Easy|
...
|500|[keyboard-row](https://leetcode.com/problems/keyboard-row)|[Python3](https://github.com/mengban/leetcode/blob/master/500-keyboard-row/keyboard-row.py)||Easy|
...
|520|[detect-capital](https://leetcode.com/problems/detect-capital)|[Python3](https://github.com/mengban/leetcode/blob/master/520-detect-capital/detect-capital.py)||Easy|
...
|530|[minimum-absolute-difference-in-bst](https://leetcode.com/problems/minimum-absolute-difference-in-bst)|[Python3](https://github.com/mengban/leetcode/blob/master/530-minimum-absolute-difference-in-bst/minimum-absolute-difference-in-bst.py)||Easy|
...
|575|[distribute-candies](https://leetcode.com/problems/distribute-candies)|[Python3](https://github.com/mengban/leetcode/blob/master/575-distribute-candies/distribute-candies.py)|[:memo:](https://leetcode.com/articles/distribute-candies/)|Easy|
...
|599|[minimum-index-sum-of-two-lists](https://leetcode.com/problems/minimum-index-sum-of-two-lists)|[Python3](https://github.com/mengban/leetcode/blob/master/599-minimum-index-sum-of-two-lists/minimum-index-sum-of-two-lists.py)|[:memo:](https://leetcode.com/articles/minimum-index-sum-of-two-lists/)|Easy|
...
|645|[set-mismatch](https://leetcode.com/problems/set-mismatch)|[Python3](https://github.com/mengban/leetcode/blob/master/645-set-mismatch/set-mismatch.py)|[:memo:](https://leetcode.com/articles/set-mismatch/)|Easy|
...
|682|[baseball-game](https://leetcode.com/problems/baseball-game)|[Python3](https://github.com/mengban/leetcode/blob/master/682-baseball-game/baseball-game.py)|[:memo:](https://leetcode.com/articles/baseball-game/)|Easy|
...
|792|[binary-search](https://leetcode.com/problems/binary-search)|[Python3](https://github.com/mengban/leetcode/blob/master/792-binary-search/binary-search.py)||Easy|
...
|874|[backspace-string-compare](https://leetcode.com/problems/backspace-string-compare)|[Python3](https://github.com/mengban/leetcode/blob/master/874-backspace-string-compare/backspace-string-compare.py)|[:memo:](https://leetcode.com/articles/backspace-string-compare/)|Easy|
